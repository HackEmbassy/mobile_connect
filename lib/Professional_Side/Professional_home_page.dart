                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              "Welcome ${model.profession} ${model.fullName}",
                              style: TextStyle(
                                fontSize: 14.sp,
                                fontWeight: FontWeight.bold,
                                color:
                                    Color(0xFF0B2240), // Dark blue text color
                              ),
                            ),
                            SizedBox(height: 4),
                            Text(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: const Icon(
                                Icons.edit,
                                color: Color(0xFF103F87), // Dark Blue color
                                size: 20,
                              ),
                            ),
                          ),
                          ...
                          Positioned(
                            bottom:
                                -55, // Positioning to overlay on the main card
                            left: 16,
                            right: 16,
                            child: Container(
                      ...
                      const SizedBox(
                          height:
                              60), // Adjusted to accommodate the overlay card
                      const Text(
                        "Our Clients",
                        style: TextStyle(
                          fontSize: 20,
