              ...
              decoration: widget.config.decoration ??
                  InputDecoration(
                      ...
                      focusedBorder: widget.config.focusedBorder ??
                          OutlineInputBorder(
                              borderRadius:
                                  BorderRadius.circular(widget.config.radius.r),
                      ...
                      focusedErrorBorder: widget.config.focusedErrorBorder ?? OutlineInputBorder(borderRadius: BorderRadius.circular(widget.config.radius.r), borderSide: const BorderSide(color: Colors.red)),
                      disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(widget.config.radius.r), borderSide: const BorderSide(color: AppColors.primary)),
                      ...
                      suffixIcon: Align(widthFactor: 1.0, heightFactor: 1.0, child: widget.config.suffixIconWidget))),
        )
      ],
    );
  }
